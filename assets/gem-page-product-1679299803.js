    ...
    (function( jQuery ){
  var $module = jQuery('#m-1679288968441').children('.module');
  $module.gfV3Product();
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1679289389145').children('.module');
  ...
  switch(style) {
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1679289371564').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1679289666827').children('.module');
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1679300174193').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1679289771348').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1679975859379').children('.module');
