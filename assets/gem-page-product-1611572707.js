...
jQuery(function() {
  ...
  var $module = jQuery('#m-1612959883405').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1612959883405').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1612959883405');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1612959883405').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1612959883405').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1612959883405').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
...
(function( jQuery ){
  var $module = jQuery('#m-1612960249745').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1636943682711').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1636943697738').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1641997902293').children('.module');   
    var navspeed = $module.data('navspeed'),
