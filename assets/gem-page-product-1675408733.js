...
(function( jQuery ){
  // var $module = jQuery('#m-1636616473589').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1636616496468').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1669257939812').children('.module');   
    var navspeed = $module.data('navspeed'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1642372738562').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
