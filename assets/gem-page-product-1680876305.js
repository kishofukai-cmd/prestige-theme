...
jQuery(function() {
  ...
  if (mode == 'dev') {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1680591055705').children('.module');
  $module.gfV3Product();
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1680591635448').children('.module');
  ...
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1680591766737').children('.module');
  ...
  switch(style) {
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1680593033803').children('.module');
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1680593103768').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1680593305818').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1680593377232').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1680873256176').children('.module');
